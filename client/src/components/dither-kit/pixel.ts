...
export function bayer4(row: number, col: number) {
...
export function pixelBloomStyle(bloom: PixelBloom): PixelBloomStyle | null {
  ...
  return {
    ...
    opacity: `calc(${cfg.opacity} * var(--pixel-bloom-opacity, 1))`,
    mixBlendMode: 'plus-lighter',
    imageRendering: 'auto',
  }
}
